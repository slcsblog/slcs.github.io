    ...
    var k = function(t) {
        ...
        Object.defineProperty(e.prototype, "state", {
            ...
            set: function(t) {
                ...
                case i.PLAYING:
                    break;
                case i.LOSE:
                    this.setStatusText(f.default("The cat’s at the edge of the map. You lose."));
                    break;
                case i.WIN:
                    this.setStatusText(f.default("The Cat’s Got Nowhere to go. You win."));
                    break;
                default:
                    return
                }
        ...
        e.prototype.playerClick = function(t, e) {
            ...
            this.state !== i.PLAYING)
                return this.setStatusText(f.default("The game is over. We’re back in business.")),
                this.reset(),
                !1;
            var n = this.getBlock(t, e);
            return n ? n.isWall ? (this.setStatusText(f.default("The Click is already on the wall. Do Not Click.")),
            !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("Click position is the cat’s current position, click is not allowed.")),
            !1) : (n.isWall = !0,
            this.cat.isCaught() ? (this.setStatusText(f.default("The Cat’s Got Nowhere to go. You win.")),
            this.state = i.WIN,
            !1) : (this.setStatusText(f.default("You clicked on ") + "(" + t + ", " + e + ")"),
            this.cat.step() || (this.setStatusText(f.default("The cat quits. You win.！")),
            this.state = i.WIN),
            !0)) : (this.setStatusText(f.default("Code error. Current location does not exist.")),
            !1)
        }
        ,
        e.prototype.reset = function() {
            ...
            this.randomWall(),
            this.state = i.PLAYING,
            this.setStatusText(f.default("Click on the Dot to surround the kitten."))
        }
        ,
...
, function(t, e, n) {
    ...
    var i = n(2)
      , s = function(t) {
        function e(e) {
            var n = t.call(this, e, 0, 0, i.default("Again"), {}) || this;
            n.setColor("#000000");
            var o = e.r;
            n.setFontSize(o),
